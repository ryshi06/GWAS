...
diag.geno.file <- "./GWAS5_diag.geno.RData"
...
diag.geno <- createDataFile(path=path_to_data, 
                            geno.file, 
                            file.type="gds",
                            variables = "genotype",
...
# create an R image for the diagnostic file
diag.qxy.file <- "./GWAS5_diag.qxy.RData"
...
# create an R image for the diagnostic file
diag.bl.file <- "./GWAS5_diag.bl.RData"
