...
load("./GWAS4/GWAS_4_Annotation.RData")
...
path_to_data <- "./GWAS4/Processed"

# create a gds file to store genotypes in the same path
geno.file <- "./GWAS4/GWAS4_geno.gds"

# create an R image for the diagnostic file
diag.geno.file <- "./GWAS4/GWAS4_diag.geno.RData"
...
qxy.file <- "./GWAS4/GWAS4_qxy.gds"

# create an R image for the diagnostic file
diag.qxy.file <- "./GWAS4/GWAS4_diag.qxy.RData"
...
bl.file <- "./GWAS4/GWAS4_bl.gds"

# create an R image for the diagnostic file
diag.bl.file <- "./GWAS4/GWAS4_diag.bl.RData"
